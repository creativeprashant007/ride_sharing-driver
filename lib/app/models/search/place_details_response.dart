class PlaceDetailsResponse {
  ...
  PlaceDetailsResponse({this.placeDetailResult, this.status});

  PlaceDetailsResponse.fromJson(Map<String, dynamic> json) {
    placeDetailResult = json['place_detail_result'] != null
        ? new PlaceDetailResult.fromJson(json['place_detail_result'])
        : null;
    status = json['status'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.placeDetailResult != null) {
      data['place_detail_result'] = this.placeDetailResult!.toJson();
    }
...
class PlaceDetailResult {
  ...
  PlaceDetailResult.fromJson(Map<String, dynamic> json) {
